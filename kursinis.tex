...
\caption{Trejeto tinklo mokymosi procesas} % Antraštė įterpiama po paveikslėlio
\label{img:mlp}
\end{figure}
\pagebreak
...
Artima šiai funkcijai yra ši lygtis. Ji naudoja kvadratinį Euklido atstumą kaip atstumo metriką ir $\alpha > 0$, nurodanti ribą tarp dviejų vaizdų ir absoliučios sumos reikšmės.
...
Viena iš šios problemos sprendimo būdų yra naudoti erdvinės piramidės talpinimą.
\linebreak
